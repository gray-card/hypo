...
- **Scene graphs:** regions, nodes, and edges on a photo, with optional provider-generated alt text and object analysis, types grounded to Wikidata, and semantic search over what's actually in each frame.
