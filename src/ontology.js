...
export const RELATION_CONCEPTS = {
  ...
  inside: {
    label: "inside",
    category: "topological-containment",
    lex: ["inside", "in", "within", "inside of", "contained in", "enclosed in", "throughout"],
    inverse: "contains",
    transitive: true,
  },
  contains: {
    label: "contains",
    category: "topological-containment",
    lex: ["contains", "containing", "contain", "encloses", "enclosing", "holds", "holding"],
    inverse: "inside",
    transitive: true,
  },
  outside: {
    label: "outside",
    category: "topological-containment",
    lex: ["outside", "outside of", "out of", "without", "exterior to"],
  },
  ...
  "on-top-of": {
    ...
    axis: "vertical",
    contact: true,
    lex: ["on top of", "atop", "on", "upon", "on the top of", "resting on", "sitting on"],
    inverse: "underneath",
  },
  underneath: {
    label: "underneath",
    ...
    axis: "vertical",
    contact: true,
    lex: ["underneath", "under", "on the bottom of", "on the underside of"],
    inverse: "on-top-of",
  },
  against: {
    label: "against",
    category: "support-contact",
    contact: true,
    lex: ["against", "up against", "leaning against", "leaning on", "propped against"],
  },
  touching: {
    label: "touching",
    category: "support-contact",
  ...
  above: {
    ...
    axis: "vertical",
    contact: false,
    lex: ["above", "over", "higher than", "overhead of", "up above"],
    inverse: "below",
    transitive: true,
  },
  below: {
    ...
    axis: "vertical",
    contact: false,
    lex: ["below", "beneath", "lower than", "under", "down below"],
    inverse: "above",
    transitive: true,
  },
  ...
  "in-front-of": {
    label: "in front of",
    category: "frontal-axis",
    axis: "frontal",
    lex: ["in front of", "ahead of", "before", "in the front of", "fore of", "front of"],
    inverse: "behind",
    transitive: true,
  },
  behind: {
    ...
    category: "frontal-axis",
    axis: "frontal",
    lex: ["behind", "in back of", "to the rear of", "aft of", "after"],
    inverse: "in-front-of",
    transitive: true,
  },
  ...
  "left-of": {
    label: "left of",
    category: "lateral-axis",
    axis: "lateral",
    lex: ["left of", "to the left of", "on the left of", "to the left"],
    inverse: "right-of",
    transitive: true,
  },
  "right-of": {
    ...
    category: "lateral-axis",
    axis: "lateral",
    lex: ["right of", "to the right of", "on the right of", "to the right"],
    inverse: "left-of",
    transitive: true,
  },
  ...
  "north-of": {
    label: "north of",
    category: "frame-absolute",
    lex: ["north of", "to the north of", "northward of"],
    inverse: "south-of",
    transitive: true,
  },
  "south-of": {
    label: "south of",
    category: "frame-absolute",
    lex: ["south of", "to the south of", "southward of"],
    inverse: "north-of",
    transitive: true,
  },
  "east-of": {
    label: "east of",
    category: "frame-absolute",
    lex: ["east of", "to the east of", "eastward of"],
    inverse: "west-of",
    transitive: true,
  },
  "west-of": {
    label: "west of",
    category: "frame-absolute",
    lex: ["west of", "to the west of", "westward of"],
    inverse: "east-of",
    transitive: true,
  },
  "northeast-of": {
    label: "northeast of",
    category: "frame-absolute",
    lex: ["northeast of", "to the northeast of"],
    inverse: "southwest-of",
    transitive: true,
  },
  "southwest-of": {
    label: "southwest of",
    category: "frame-absolute",
    lex: ["southwest of", "to the southwest of"],
    inverse: "northeast-of",
    transitive: true,
  },
  "northwest-of": {
    label: "northwest of",
    category: "frame-absolute",
    lex: ["northwest of", "to the northwest of"],
    inverse: "southeast-of",
    transitive: true,
  },
  "southeast-of": {
    label: "southeast of",
    category: "frame-absolute",
    lex: ["southeast of", "to the southeast of"],
    inverse: "northwest-of",
    transitive: true,
  },
  ...
  "upstream-of": {
    label: "upstream of",
    category: "gradient",
    lex: ["upstream of", "up the river from"],
    inverse: "downstream-of",
    transitive: true,
  },
  "downstream-of": {
    label: "downstream of",
    category: "gradient",
    lex: ["downstream of", "down the river from"],
    inverse: "upstream-of",
    transitive: true,
  },
  "uphill-from": {
    label: "uphill from",
    category: "gradient",
    lex: ["uphill from", "up the slope from"],
    inverse: "downhill-from",
    transitive: true,
  },
  "downhill-from": {
    label: "downhill from",
    category: "gradient",
    lex: ["downhill from", "down the slope from"],
    inverse: "uphill-from",
    transitive: true,
  },
  "upwind-of": {
  ...
  "clear-of": {
    label: "clear of",
    category: "proximity-negative",
    lex: ["clear of", "out of the way of", "well clear of"],
  },
  "out-of-sight-of": {
    label: "out of sight of",
    category: "proximity-negative",
    lex: ["out of sight of", "hidden from", "obscured from"],
  },
  "out-of-reach-of": {
    label: "out of reach of",
    category: "proximity-negative",
    lex: ["out of reach of", "beyond the reach of"],
  },
  ...
  between: {
    ...
    arity: "ternary",
    lex: ["between", "in between", "betwixt", "halfway between", "midway between"],
  },
  among: {
    label: "among",
    category: "betweenness",
    arity: "collective",
    lex: ["among", "amongst", "amid", "amidst", "in the midst of", "in the thick of"],
  },
  flanking: {
    label: "flanking",
    category: "betweenness",
    arity: "collective",
    lex: ["flanking", "on either side of", "either side of", "on both sides of"],
  },
  ...
  surrounding: {
    ...
    lex: ["surrounding", "encircling", "ringing", "around", "round", "girdling"],
    inverse: "surrounded-by",
    transitive: true,
  },
  "surrounded-by": {
    label: "surrounded by",
    category: "surrounding",
    lex: ["surrounded by", "encircled by", "ringed by", "hemmed in by"],
    inverse: "surrounding",
    transitive: true,
  },
  ...
  "parallel-to": {
    ...
    lex: ["parallel to", "in line with", "aligned with", "collinear with"],
    symmetric: true,
    transitive: true,
  },
  "perpendicular-to": {
    ...
    category: "orientation",
    lex: ["perpendicular to", "at right angles to", "athwart", "normal to"],
    symmetric: true,
  },
  "level-with": {
    label: "level with",
    category: "orientation",
    lex: ["level with", "even with", "at the level of", "abreast of", "abeam of", "at the same height as"],
    symmetric: true,
    transitive: true,
  },
  facing: {
    label: "facing",
    category: "orientation",
    lex: ["facing", "oriented toward", "pointing at", "turned toward"],
  },

  // ===== Frame-relative (far/near side; opposition) =====
  opposite: {
    label: "opposite",
    category: "frame-relative",
    lex: ["opposite", "across from", "catercorner from", "kitty-corner from", "vis-a-vis", "diagonally across from"],
    symmetric: true,
  },
  beyond: {
    label: "beyond",
    category: "frame-relative",
    lex: ["beyond", "on the far side of", "past"],
    inverse: "this-side-of",
    transitive: true,
  },
  "this-side-of": {
    label: "this side of",
    category: "frame-relative",
    lex: ["this side of", "on the near side of", "short of"],
    inverse: "beyond",
    transitive: true,
  },
  ...
  "in-the-middle-of": {
    label: "in the middle of",
    category: "region-relative",
    lex: [
      "in the middle of",
      "in the center of",
      "at the center of",
  ...
  "at-the-corner-of": {
    label: "at the corner of",
    category: "region-relative",
    lex: ["at the corner of", "in the corner of"],
  },
  "at-the-top-of": {
    label: "at the top of",
    category: "region-relative",
    lex: ["at the top of", "at the upper part of"],
  },
  "at-the-bottom-of": {
    label: "at the bottom of",
    category: "region-relative",
    lex: ["at the bottom of", "at the foot of", "at the base of", "at the lower part of"],
  },
  "at-the-back-of": {
    label: "at the back of",
    category: "region-relative",
    lex: ["at the back of", "at the rear of", "in the back of"],
  },
  "at-the-front-of": {
    label: "at the front of",
    category: "region-relative",
    lex: ["at the front of", "in the front of", "at the head of"],
  },
  ...
  "part-of": {
    label: "part of",
    category: "mereology",
    lex: ["part of", "a part of", "component of", "piece of"],
    inverse: "has-part",
    transitive: true,
  },
  "has-part": {
    label: "has part",
    category: "mereology",
    lex: ["has part", "made up of", "composed of"],
    inverse: "part-of",
    transitive: true,
  },
  ...
  "out-from": {
    label: "out of (motion)",
    category: "path-directional",
    lex: ["out from", "outward from", "out of"],
    opposite: "into",
  },
  ...
  toward: {
    label: "toward",
    category: "path-directional",
    lex: ["toward", "towards", "in the direction of", "headed for", "en route to"],
    opposite: "away-from",
  },
  "away-from": {
    label: "away from",
    category: "path-directional",
    lex: ["away from", "receding from"],
    opposite: "toward",
  },
  ...
  down: {
    label: "down (motion)",
    category: "path-directional",
    lex: ["down", "downward", "downwards"],
    opposite: "up",
  },
  "over-path": {
    label: "over (path)",
    category: "path-directional",
    lex: ["over", "across the top of"],
    opposite: "under-path",
  },
...
export function resolveRelation(input) {
  ...
  if (ID_BY_NORM.has(key)) {
    const id = ID_BY_NORM.get(key);
